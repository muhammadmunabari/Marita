...
/// Marita's dark theme generator.
/// Maps the dark design token specifications to [MaritaColorPalette]
/// and provides the global [ThemeData] in a Dark Mode context.
class MaritaDarkTheme {
  MaritaDarkTheme._();

  /// Builds the dark-mode [ThemeData] aligned with the semantic tokens.
  static ThemeData build() {
    const palette = MaritaColorPalette(
      // Text & icons
      contentPrimary: BaseColors.cloud50,     // White — WCAG AA on shadow900 bg
      contentSecondary: BaseColors.cloud600,   // Light grey
      contentTertiary: BaseColors.cloud700,    // Mid grey
      contentInverse: BaseColors.shadow900,    // Near-black — on lime buttons
      contentDisabled: BaseColors.shadow400,   // Muted grey

      // Surfaces
      backgroundPrimary: BaseColors.shadow900,   // #141510 — page bg
      backgroundSecondary: BaseColors.shadow800, // #22231A — card / input bg
      backgroundInverse: BaseColors.cloud50,     // White

      // Brand (lime) — interactive elements use lime scale
      interactivePrimary: BaseColors.lime500,    // #E4FF1A — CTA buttons, links
      interactiveSecondary: BaseColors.lime400,  // #E8FF38 — secondary actions
      interactiveDisabled: BaseColors.shadow600, // Muted

      // Borders
      borderPrimary: BaseColors.shadow500,       // Dividers, default borders
      borderSecondary: BaseColors.shadow600,     // Subtle borders
