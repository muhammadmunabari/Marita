      ...
      // Handle Normal Paragraphs
        ...
        if (isKeyPoint) {
          widgets.add(pw.Container(
            ...
            child: _buildRichText(line.replaceAll('**', '').trim(), base, bold, italic, boldItalic, 10, textColor: PdfColors.black),
          ));
        } else {
          widgets.add(pw.Padding(
    ...
    return pw.Container(
      ...
      child: pw.Column(
        ...
        children: [
          pw.Text(
            'DISCLAIMER',
            style: pw.TextStyle(font: bold, fontSize: 10, color: PdfColors.black),
          ),
          ...
          pw.Text(
            ...
            style: pw.TextStyle(font: base, fontSize: 8, color: PdfColors.black),
          ),
          ...
          pw.Row(
            ...
            children: [
              pw.Column(
                crossAxisAlignment: pw.CrossAxisAlignment.start,
                children: [
                  pw.Text('REPORT ID:', style: pw.TextStyle(font: bold, fontSize: 7, color: PdfColors.black)),
                  pw.Text('MRT-${DateTime.now().millisecondsSinceEpoch}', style: pw.TextStyle(font: base, fontSize: 7, color: PdfColors.black)),
                ],
              ),
              pw.Column(
                crossAxisAlignment: pw.CrossAxisAlignment.end,
                children: [
                  ...
                  pw.Text('AUTHORIZED SIGNATURE', style: pw.TextStyle(font: base, fontSize: 6, color: PdfColors.black)),
                ],
              ),
            ],
          ),
