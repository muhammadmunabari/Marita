...
* If information is unavailable, state "Not Available in Source Document".
...
* Never create, estimate, infer, or fabricate financial figures.
* If information is unavailable, state "Not Available in Source Presentation".
...
* Analyze procurement documents objectively.
* Use only information available in source documents.
* Never assume missing information.
* Identify discrepancies, exceptions, and control weaknesses.
...
* Analyze all relevant numerical datasets.
* Use Benfords Law as a statistical anomaly detection technique.
